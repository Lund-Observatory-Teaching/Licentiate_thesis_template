% Here you describe the data you used, how it was collected, why this data was used instead of others, etc.  Then describe how this data was used to get your results (the methodology). (5-10 pages)
